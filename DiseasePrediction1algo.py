...
#url_training = "https://github.com/bansal6498/Project_Machine_learning/blob/master/Training.csv"
#response = http.request('GET', url_training)
#data_training = response.read()

#url_testing = "https://github.com/bansal6498/Project_Machine_learning/blob/master/Testing.csv"
#response = http.request('GET',url_testing)
#data_testing = response.read()
#print(data_testing)
#print(data_training)
...
#w2 = Label(root, justify=LEFT, text="A Project by Priyanshu Bansal", fg="white", bg="Green")
